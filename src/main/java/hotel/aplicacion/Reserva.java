...
public class Reserva {
    ...
    /**
     * Calcula el coste total de la reserva teniendo en cuenta el numero de noches,
     * el tipo de habitación y si ha solicitado cama supletoria. 
     * 
     * El cálculo se realiza de la siguiente forma:
     *	- Se determina el nº de noches entre la fecha de entrada y salida
     *	- Se asigna un precio por noche segun el tipo de habitacion
     *	- Si la reserva incluye cama supletoria se incrementa el precio
     *	- Si la duracion de la reserva es para mas de 7 noches se aplica descuento 
     *
    ...
    /**
     * 
     * @return Devuelve los detalles de la reserva
     */
